...
class Options {
  ...
  ///  [RestClient] will throw the [RestServiceAPIError] with [RestServiceAPIErrorType.RECEIVE_TIMEOUT].
  ///
  ...
  /// you can set `ContentType.parse("application/x-www-form-urlencoded")`, and [RestClient]
