...
class BaseAPI implements RestAPI {
  ...
  static RestClient? _restServiceAPI;
  ...
  BaseAPI._internal() {
    ...
    if (_restServiceAPI == null) {
      _restServiceAPI = new RestClient(getFuseOptions());
    }
  }
  ...
  Future<Response> get(url, {dynamic data, options}) async {
    ...
    return getFromApi(url, data: data, options: options);
  }
  ...
  Future<Response> delete(url, {dynamic data, Options? options}) async {
    Map? filteredData;
