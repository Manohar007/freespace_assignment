...
class RestClient {
  ...
  /// [RestClient] will create new HttpClient when it is needed.

  HttpClient _httpClient = new HttpClient();

  /// Handy method to make http GET request, which is a alias of  [RestClient.request].
  ...
  /// Handy method to make http POST request, which is a alias of  [RestClient.request].
  ...
  /// Handy method to make http PUT request, which is a alias of  [RestClient.request].
  ...
  /// Handy method to make http DELETE request, which is a alias of  [RestClient.request].
